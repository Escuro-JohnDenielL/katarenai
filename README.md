...
| Collection Name | Fields Summary                                                                                                   | Notes                                 |
|------------------|------------------------------------------------------------------------------------------------------------------|----------------------------------------|
| `users`          | `email`, `password`, `first_name`, `last_name`, `role`, `status`, `created_at`, `updated`                      | Auth collection with role and status  |
| `document`       | `document`, `type`, `status`, `submission_date`, `feedback`, `attachment`, `uploadedBy`, `department`, etc.     | Related to `users` by `uploadedBy`    |
| `request`        | `sent_to`, `sent_by`, `document`, `created`, `updated`                                                          | Tracks which user sends which document |
...
| Backend      | Pocketbase                             |
| Database     | Pocketbase                             |
| Hosting      | Pocketbase, Angular CLI                |
| Versioning   | GitHub                                 |
